...
├── experiments/    # AI training, MLflow tracking, and model research notebooks
...
- **AI Experiments (`experiments/`)**: Model training and evaluation suites for PaddleOCR, Gemini API, PyTorch/TensorFlow HTR, and LangChain/LangGraph NLU pipelines tracked with MLflow.
...
- [AI Experiments & Model Training Guide](experiments/README.md)
